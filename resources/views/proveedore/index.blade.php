                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
										...
										<th>Proveedornumero</th>
										<th>Proveedorcorreo</th>
										<th>Proveedorencargado</th>
										<th>Proveedorrtn</th>
										<th>Estado</th>
                                ...
                                <tbody>
                                    @foreach ($proveedores as $proveedore)
                                        <tr>
											...
											<td>{{ $proveedore->proveedorNombre }}</td>
											<td>{{ $proveedore->proveedorNumero }}</td>
											<td>{{ $proveedore->proveedorCorreo }}</td>
											<td>{{ $proveedore->proveedorEncargado }}</td>
											<td>{{ $proveedore->proveedorRTN }}</td>
